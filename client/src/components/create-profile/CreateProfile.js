        ...
        <div className="container">
            <div className="row">
                <div className = "col-md-8 m-auto">
                    ...
                    <SelectListGroup placeholder="* Status" name="status" value={this.state.status} onChange={this.onChange} error={errors.staus}
                    options = {options} 
                    ...
                    <TextFieldGroup placeholder="Website" name="company" value={this.state.website} onChange={this.onChange} error={errors.website} 
